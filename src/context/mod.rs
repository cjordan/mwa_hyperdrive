...
pub(crate) struct ObsContext {
    ...
    /// indexed.
    ///
    /// Why is this distinguished? An observation with 128 tiles *should* have
    /// solutions for 128 tiles. It would look weird if, for example, one tile
    /// was not included in the input data and the output data described 127
    /// tiles.
